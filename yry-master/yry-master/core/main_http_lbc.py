...
def face_point():
    ...
    if is_exp == 0:
        conn = pymysql.connect(host='192.168.20.30', port=3306, user='tbroot', password='tbmima7800', db='lbc')
        cursor = conn.cursor()
...
def reg():
    ...
    model_image_nan = "/home/scy/face_fusion/yry-master/yry-master/images/nan_lu.png"
    if is_exp == 1:
        conn = pymysql.connect(host='192.168.20.30', port=3306, user='tbroot', password='tbmima7800', db='lbc')
        cursor = conn.cursor()
